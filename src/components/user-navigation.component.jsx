...
const UserNavigationPanel = () => {
    ...
    return (
        <AnimationWrapper className="absolute right-0 z-50" transition={{ duration: 0.2 }}>
            <div className="bg-white rounded-lg absolute right-0 border border-grey w-60 overflow-hidden duration-200">
                ...
                <button className="text-left p-4 hover:bg-grey w-full pl-8 py-4" onClick={signOutUser}>
                    <h1 className="font-bold text-md mg-1">Sign Out</h1>
